...
public class CustomSpinner extends AppCompatSpinner {
    ...
    //Klasa napravljena u slucaju ako zatreba custom spinner jer daje vise slobode u handlanju  i modificiranju spinnera
    //U ovom slucaju prvenstveno zbog:  void onPopupWindowOpened(Spinner spinner);
